              ...
              <div className="it-about-3-title-box">
                <div className="it-choose-content">
                  ...
                  <h5 style={{ textAlign: "justify" }}>
                    ...
                    used by clinicians caring for multiple patients. In this
                    mode, the Vitals360 vital signs monitor replaces a number of
                    separate medical devices, making it ideal for care both
                    inside and outside of an office or facility.
                  </h5>
                  <h5 style={{ textAlign: "justify" }}>
                    ...
                    connectivity to allow patient monitor data to be
                    automatically uploaded after every use.
                  </h5>
                  <h5 style={{ textAlign: "justify" }}>
                    <i className="fa-solid fa-circle-check"></i>Additionally,
                    the Vitals360’s GPS location and time-stamping provide a
                    superior audit trail for Medicare reimbursement.
                  </h5>
                </div>
              </div>
            </div>
            ...
            >
              ...
              <div className="it-about-3-title-box  mb-30">
                <div className="it-choose-content">
                  ...
                  <h5>
                    <i className="fa-solid fa-circle-check"></i>On-device
                    software maintained by VoCare
                  </h5>
                  <h5>
            ...
            >
              ...
              <div className="it-about-3-title-box  mb-30">
                <div className="it-choose-content">
                  ...
                  <h5>
                    <i className="fa-solid fa-circle-check"></i>Supports all
                    major video conference services.
                  </h5>
                </div>
              </div>
              <div className="it-about-3-title-box">
                <div className="it-choose-content">
                  ...
                  <h5>
                    <i className="fa-solid fa-circle-check"></i>WiFi (when LTE
                    is not available)
                  </h5>
                  <h5 style={{ textAlign: "justify" }}>
                    <i className="fa-solid fa-circle-check"></i>Cloud
                    Integration services through partners, including Application
                    Programming Interfaces (API), an FDA listed Class I Medical
                    Device Data System (880.6310) as well as custom solutions to
                    provide a device and platform that allows our customers to
                    define and deliver solutions for their respective space of
                    influence.
                  </h5>
                </div>
              </div>
